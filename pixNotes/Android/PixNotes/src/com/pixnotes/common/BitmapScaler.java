...
public class BitmapScaler {
    ...
    public BitmapScaler(String imgPath, int newWidth)
    {
        Size size = getRoughSize(imgPath, newWidth);
        roughScaleImage(imgPath, size);
        scaleImage(newWidth);
    }
    ...
    private void roughScaleImage(String imgPath, Size size) {
        Matrix matrix = new Matrix();
        matrix.postScale(size.scale, size.scale);
 
        BitmapFactory.Options scaledOpts = new BitmapFactory.Options();
        scaledOpts.inSampleSize = size.sample;
        scaled = BitmapFactory.decodeFile(imgPath, scaledOpts);
    }
    ...
    private Size getRoughSize(String imgPath, int newWidth) {
        BitmapFactory.Options o = new BitmapFactory.Options();
        o.inJustDecodeBounds = true;
