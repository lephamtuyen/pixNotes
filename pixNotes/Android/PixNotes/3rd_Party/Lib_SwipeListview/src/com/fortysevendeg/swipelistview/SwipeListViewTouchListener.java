...
public class SwipeListViewTouchListener implements View.OnTouchListener {
	...
	private int mLimitDistanceBackView;
    ...
    // DuongHH ----------- Customer Dismiss Action
    public void dismissView(final boolean swap, final boolean swapRight, final int position)
    {
    	int moveTo = 0;
        if (opened.get(position)) {
            if (!swap) {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (viewWidth < 2) {
            ...
            leftOffset = viewWidth - mLimitDistanceBackView;
        }
        switch (MotionEventCompat.getActionMasked(motionEvent)) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                } else if (Math.abs(deltaX) > mLimitDistanceBackView) {
                    swap = true;
                    swapRight = deltaX > 0;
                }
...
//                }
	...
	public int getmLimitDistanceBackView() {
		return mLimitDistanceBackView;
	}

	public void setmLimitDistanceBackView(int mLimitDistanceBackView) {
		this.mLimitDistanceBackView = mLimitDistanceBackView;
	}
